...
import com.nbgsoftware.gbrains.databinding.LayoutCustomImageViewBinding;

public class CustomImageView extends ConstraintLayout {
    private LayoutCustomImageViewBinding binding;
    ...
    public CustomImageView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
